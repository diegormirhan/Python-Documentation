...
Classes podem conter:
    ...
    iríamos querer saber se a lâmpada é 110 ou 220 volts; se elaa é branca, amarela, vermelha;
    qual a luminosidade dela e etc.

    - Métodos (funções) -> Representam os comportamentos do objeto (o que ele vai fazer).
    Ou seja, as ações que este objetos pode realizar no seu sistema. No caso da lâmpada,
    por exemplo, um comportamento comum que muito provavelmente iríamos querer representar
