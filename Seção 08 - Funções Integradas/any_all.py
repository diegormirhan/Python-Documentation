...
print(all(["Diego"]))  # Todos os números são verdadeiros? True


nomes = ['Carlos', 'Camila', 'Carla', 'Casemiro', 'Cristina']

print(all([nome[0] == 'C' for nome in nomes]))

# OBS: Um iterável vazio convertido em boolean é False, mas o all() entende como True
print(all([letra for letra in 'abc' if letra in 'abcdefg']))

print(all([num for num in [2, 4, 6, 8, 10] if num % 2 == 0]))


any() -> Retorna True se qualquer elemento iterável for verdadeiro. Se o iterável estiver vazio, retorna False
"""
...
print(any([num for num in [2, 4, 6, 8, 10] if num % 2 == 0]))  # True
